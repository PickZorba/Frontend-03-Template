...
function layout(element) {
    ...
    // 把元素样式的 width 和 height 为空或 auto 的值统一设为 null
    ...
    */
    ...
    /*
    设置各个 flexDirection 的默认值
    mainSize 为主轴方向、mainStart 为主轴起点、mainEnd 为主轴终点
    mainSign 为主轴延伸方向、mainBase 为主轴基准点
    crossSize 为交叉轴方向、crossStart 为交叉轴起点、crossEnd 为交叉轴终点
    crossSign 为交叉轴延伸方向、crossBase 为交叉轴基准点;
    */
    ...
    if(!style[mainSize]) {
        ...
        for(let i = 0; i < items.length; i++) {
            ...
            if(itemStyle[mainSize] !== null || itemStyle[mainSize]) {
                elementStyle[mainSize] += item.style[mainSize]
            }
            isAutoMainSize = true;
        }
    }
